...
Workspace Team at `/app/workspaces/{workspaceSlug}/team` is Owner/Admin-only. Active members open a read-only identity/member-details modal with permission-controlled role management, advisory member edit sessions, optimistic snapshot concurrency and role-change audit events. Invited members remain non-interactive in this individual-member slice; invitation lifecycle and CSV administration remain separate journeys.
